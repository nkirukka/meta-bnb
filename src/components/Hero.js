    ...
    return (
        <section>
            <div className='flex flex-col-reverse w-[90%] mx-auto mt-24 '>
                <div>
                    <h1 className='text-center text-3xl my-8 text-[#434343] md:text-5xl'>Rent a <span className='font-semibold text-[#A02279] '>Place </span>
                    ...
                    <p className='text-center text-[#434343] mb-8 md:text-xl'>
